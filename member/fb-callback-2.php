...
try {
  ...
  exit;
	...
	$sql = "update getrich_users_facebook set facebook_name='".$userNode->getName()."',facebook_uid='".$userNode->getField('id')."',facebook_token='".$accessToken->getValue()."',facebook_expired='".$expired_token."',facebook_status=1 where facebook_user='".$_SESSION['user_data']->user_id."' and facebook_type='2'";			
